...
interface DiseaseNutrientsSelectProps {
  nutrients: Nutrient[];
...
export function DiseaseNutrientsSelect({ nutrients, onChange }: DiseaseNutrientsSelectProps) {
        ...
        {nutrients.length === 0 ? (
          ...
          nutrients.map((nutrient, index) => (
            <Badge
              key={index}
              variant="secondary"
              className="bg-blue-100 text-blue-800 hover:bg-blue-200 gap-1 pl-2 pr-1"
            >
