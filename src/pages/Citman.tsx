...
const Citman = () => {
  ...
  // Default selected services for Citman
  const defaultServices = [
    'Citzen●Geography-Env-Earth Scientist',
    'Citizen●Engg-Aptitude-GA-CA',
    'Citzen●Social3-Atvist-Law-Philo-RAW-NGO-Hungr',
    'Citizen●Arnab-Charan-Modi'
  ];
